        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-12 mb-2">
            ...
            <button className="btn btn-outline-info">
              <a
                href="Music/Nav/_Maahi_64(PagalWorld.com.cm).mp3"
                target="_blank"
              >
                Play▶️
              </a>
        ...
        <div className="row">
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Tainu-Khabar-Nahi(Pagal-World.Com.In).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Pao-Ki-Jutti(Pagal-World.Com.In).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/128-Paas Tere Main - Savi 128 Kbps.mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/_Heeriye_64(PagalWorld.com.cm).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/128-Assi Sajna - Intense 128 Kbps.mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Tu Hai Champion_64(PagalWorld.com.sb).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/128-Zidd Na Karo - Dedh Bigha Zameen 128 Kbps (2).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Musafir - Dedh Bigha Zameen 128 Kbps.mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Dhadke Dil Yeh Deewana Kumaar 128 Kbps.mp3"
                target="_blank"
              >
                <img
                ...
                />
                <div className="card-body">
                  <h5 className="card-title">Dil Yeh Deewana</h5>
                  <p className="card-text">Stebin Ben</p>
                </div>
              </a>
            </div>
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Jeena Sikha De_64(PagalWorld.com.sb).mp3"
                target="_blank"
              >
                <img
          ...
          <div className="col-sm-6 col-md-3 col-lg-2">
            <div className="card mb-4 max">
              <a
                href="Music/Millionaire_64(PagalWorld.com.sb).mp3"
                target="_blank"
              >
                <img
      ...
      <section className="my-2 container-fluid  bg-dark text-white">
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-12 mb-2">
            ...
            <button className="btn btn-outline-info">
              <a
                href="Music/Nav/_Soulmate_64(PagalWorld.com.cm).mp3"
                target="_blank"
              >
                Play▶️
              </a>
      ...
      <section className="my-2 container-fluid  bg-dark text-white">
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-12 mb-2">
            ...
            <br />
            <button className="btn btn-outline-info">
              <a href="Music/Nav/old_BM-Pal Pal Dil Ke Pas.mp3" target="_blank">
                Play▶️
              </a>
            </button>
          </div>
      ...
      <section className="my-2 container-fluid  bg-dark text-white">
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-12 mb-2">
            ...
            <button className="btn btn-outline-info">
              <a
                href="Music/Nav/new_128_02 - Garmi - Street Dancer 3D (2020).mp3"
                target="_blank"
              >
                Play▶️
              </a>
